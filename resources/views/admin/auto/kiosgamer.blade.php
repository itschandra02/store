            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <input type="hidden" name="account" value="kiosgamer">
...
@section('scripts')
    @if ($data)
        @if ($data->is_active)
            <script>
                $(document).ready(() => {
                    $("#panel-balance").hide();
                    $.get("{{ route('auto.kiosgamer.check') }}", (result) => {
                        if (result.success) {
    ...
    <script>
        ...
        function saveKiosAccount() {
            ...
            $.post("{{ route('auto.kiosgamer.save') }}", data, (result) => {
                if (result.success) {
                    Swal.fire('Saved!', "Your kiosgamer account has been saved.", "success");
