            ...
            <div class="col-lg-8 mx-auto mb-5">
                <div class="card bg-dark shadow">
                    <div class="card-header">
                        <h1>Privacy Policy for {{ setting('company_name') }}</h1>
                    </div>
                    <div class="card-body">

                        <p>At {{ setting('app_name') }}, accessible from {{ route('index') }}, one of our main priorities is
                            the privacy of
                            our visitors. This Privacy Policy document contains types of information that is collected and
                            recorded by {{ setting('app_name') }} and how we use it.</p>
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            ...
                            Our Privacy Policy was created with the help of the <a
                                href="https://www.privacypolicyonline.com/privacy-policy-generator/">Online Generator of
                                Privacy Policy</a>.</p>
                        ...
                        <p>{{ setting('app_name') }} follows a standard procedure of using log files. These files log
                            visitors when they visit
                        ...
                        <p>Like any other website, {{ setting('app_name') }} uses 'cookies'. These cookies are used to store
                            information
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                            ...
                            {{ setting('app_name') }}, which are sent
                        ...
                        <p>Note that {{ setting('app_name') }} has no access to or control over these cookies that are used
                            by third-party
                            advertisers.</p>

                        <h2>Third Party Privacy Policies</h2>

                        <p>{{ setting('app_name') }}'s Privacy Policy does not apply to other advertisers or websites.
                            Thus, we are advising
                        ...
                        <p>{{ setting('app_name') }} does not knowingly collect any Personal Identifiable Information from
                            children under the
