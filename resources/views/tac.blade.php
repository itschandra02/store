            ...
            <div class="col-lg-8 mx-auto mb-5">
                <div class="card bg-dark shadow">
                    ...
                    <div class="card-body">
                        ...
                        <p>We employ the use of cookies. By accessing {{ setting('app_name') }}, you agreed to use cookies
                            in agreement with
                            the {{ setting('company_name') }}'s Privacy Policy. </p>
                        ...
                        <p>Unless otherwise stated, {{ setting('company_name') }} and/or its licensors own the intellectual
                            property rights
                            for all material on {{ setting('app_name') }}. All intellectual property rights are reserved.
                            You may access this
                            from {{ setting('app_name') }} for your own personal use subjected to restrictions set in these
                            terms and
                            conditions.</p>

                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from {{ setting('app_name') }}</li>
                            <li>Sell, rent or sub-license material from {{ setting('app_name') }}</li>
                            <li>Reproduce, duplicate or copy material from {{ setting('app_name') }}</li>
                            <li>Redistribute content from {{ setting('app_name') }}</li>
                        </ul>
                        ...
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                            information in certain areas of the website. {{ setting('company_name') }} does not filter,
                            edit, publish or
                            review Comments prior to their presence on the website. Comments do not reflect the views and
                            opinions of {{ setting('company_name') }},its agents and/or affiliates. Comments reflect the
                            views and opinions of
                            the person who post their views and opinions. To the extent permitted by applicable laws,
                            {{ setting('company_name') }} shall not be liable for the Comments or for any liability,
                            damages or expenses
                            caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
                            Comments on this website.</p>

                        <p>{{ setting('company_name') }} reserves the right to monitor all Comments and to remove any
                        ...
                        <p>You hereby grant {{ setting('company_name') }} a non-exclusive license to use, reproduce, edit
                            and authorize others
                        ...
                        <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                            ...
                            hyperlink compensates the absence of {{ setting('company_name') }}; and (d) the link is in the
                            context of general
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                            our website, you must inform us by sending an e-mail to {{ setting('company_name') }}. Please
                            include your name,
                        ...
                        <p>No use of {{ setting('company_name') }}'s logo or other artwork will be allowed for linking
                            absent a trademark
                            license agreement.</p>
                        ...
                        <p>Please read <a href="{{ route('privacy_policy') }}">Privacy Policy</a></p>
